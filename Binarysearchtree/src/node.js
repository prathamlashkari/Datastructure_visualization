...
class Node {
    ...
    constructor(graphicsBuffer, parent = null, size = Node.SIZE,
        ...
        edgeThickness = Node.EDGETHICKNESS, outlineweight = Node.STROKEWEIGHT) {
        ...
        this.outlineweights = outlineweight
    ...
    ***/
    ...
    drawNode() {
        ...
        this.graphicsBuffer.circle(this.x, this.y, this.size, this.size);
        this.graphicsBuffer.strokeWeight(this.outlineweights)
